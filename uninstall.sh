...
init='{"method":"initialize","id":1,"params":{"clientInfo":{"name":"recentlydivorced-uninstaller","version":"0.3.11"}}}'
ready='{"method":"initialized","params":{}}'
clear='{"method":"config/batchWrite","id":2,"params":{"edits":[{"keyPath":"hooks.state.\"recentlydivorced@recentlydivorced:hooks/hooks.json:session_start:0:0\"","value":null,"mergeStrategy":"replace"},{"keyPath":"hooks.state.\"recentlydivorced@recentlydivorced:hooks/hooks.json:user_prompt_submit:0:0\"","value":null,"mergeStrategy":"replace"},{"keyPath":"hooks.state.\"recentlydivorced@recentlydivorced:hooks/hooks.json:stop:0:0\"","value":null,"mergeStrategy":"replace"}],"reloadUserConfig":true}}'
